...
public class BackendGameData
{
	...
	public void TetrisGameDataInsert()
	{
		if (userData == null)
		{
			userData = new UserData();
		...
		userData.maxScore = 0;
		Param param = new Param();
		param.Add("Score", userData.maxScore);

		Debug.Log("게임정보 데이터 삽입을 요청합니다.");
		var bro = Backend.GameData.Insert("Tetris_score", param);
	...
	public void TetrisGameDataGet()
	{
		var bro = Backend.GameData.GetMyData("Tetris_score", new Where());
